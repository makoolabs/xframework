...
namespace EasyMobile.Editor
{
    internal partial class EM_SettingsEditor
    {
        ...
        bool DrawResizableArray(SP arrayProperty, bool foldout, string foldoutLabel, Action<SP, int> drawElement, Action<SP> updateNewElement, bool noLabel = false, int maxSize = int.MaxValue)
        {
                              ...
                              Func<int> getSelectedIndex, Action<int> setSelectedIndex, Action<SP> drawInnerProperties)
        {
            ...
            /// Draw a button to remove <elementProperty> from <arrayProperty>.
