...
namespace EasyMobile
{
    public abstract class AdClientImpl : IAdClient, IConsentRequirable
    {
        ...
        /// <summary>
        /// All the interstitial <see cref="AdPlacement"/>(s) defined in <see cref="EM_Settings"/> (if any).
        /// </summary>
        ...
        /// <summary>
        /// All the rewarded <see cref="AdPlacement"/>(s) defined in <see cref="EM_Settings"/> (if any).
        /// </summary>
